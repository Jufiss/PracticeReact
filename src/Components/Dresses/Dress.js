      ...
      <Layout>
        ...
        >
          ...
          <Button
            ...
            style={{ marginBottom: "15px", width: "45%", marginLeft: "7px", fontSize: 12 }}
          >
            Применить
          </Button>
          <Button
            ...
            <Row style={{ paddingLeft: "26px" }} gutter={5}>
              <Col>
                <Link to={`/dress1`}>
                  <Card
                    hoverable
                    style={{ width: 240, marginRight: "16px", marginBottom: "15px" }}
                    cover={
                      <img
                        style={{ width: "100%", height: "350px", objectFit: "contain" }}
                        alt="example"
                        src="https://a.lmcdn.ru/product/M/P/MP002XW0Q3M8_22985397_1_v1_2x.jpg"
                      />
                    }
                  >
                    <Meta
                      title={
                        <span
                          style={{ overflow: "unset", whiteSpace: "normal", textOverflow: "unset" }}
                        >
                          Amie Платье{" "}
                        </span>
                      }
                      description={<span style={{ color: "black", fontSize: "16px" }}>4000 ₽</span>}
                    />
                  </Card>
                </Link>
              </Col>
                  ...
                  <Card
                    ...
                    cover={
                      <img
                        style={{ width: "100%", height: "350px", objectFit: "contain" }}
                        alt="example"
                        src="https://a.lmcdn.ru/product/M/P/MP002XW00ESG_23678000_1_v1.jpeg"
                      />
                    }
                  >
                    <Meta
                      ...
                      description={
                        <span style={{ color: "black", fontSize: "16px" }}>55000 ₽</span>
                      }
                    />
                  </Card>
                </Link>
                  ...
                  <Card
                    ...
                    cover={
                      <img
                        style={{ width: "100%", height: "350px", objectFit: "contain" }}
                        alt="example"
                        src="https://a.lmcdn.ru/product/M/P/MP002XW0FOSJ_23281823_1_v1_2x.jpg"
                      />
                    }
                  >
                    <Meta
                      ...
                      description={
                        <span style={{ color: "black", fontSize: "16px" }}>34500 ₽</span>
                      }
                    />
                  </Card>
                </Link>
                  ...
                  <Card
                    ...
                    cover={
                      <img
                        style={{ width: "100%", height: "350px", objectFit: "contain" }}
                        alt="example"
                        src="https://a.lmcdn.ru/product/M/P/MP002XW0L2DF_18107719_1_v1.jpeg"
                      />
                    }
                  >
                    <Meta
                      ...
                      description={<span style={{ color: "black", fontSize: "16px" }}>4300 ₽</span>}
                    />
                  </Card>
                </Link>
              </Col>
                  ...
                  <Card
                    ...
                    cover={
                      <img
                        style={{ width: "100%", height: "350px", objectFit: "contain" }}
                        alt="example"
                        src="https://a.lmcdn.ru/product/M/P/MP002XW0D8V9_23959392_1_v2_2x.jpg"
                      />
                    }
                  >
                    <Meta
                      ...
                      description={<span style={{ color: "black", fontSize: "16px" }}>3000 ₽</span>}
                    />
                  </Card>
                </Link>
              </Col>
                  ...
                  <Card
                    ...
                    cover={
                      <img
                        style={{ width: "100%", height: "350px", objectFit: "contain" }}
                        alt="example"
                        src="https://a.lmcdn.ru/img135x194/M/P/MP002XW0EJB4_23458192_1_v1_2x.jpg"
                      />
                    }
                  >
                    <Meta
                      ...
                      description={<span style={{ color: "black", fontSize: "16px" }}>2000 ₽</span>}
                    />
                  </Card>
                </Link>
              </Col>
